(function() {
  ...
  var ListNewsLoginCtrl = function($scope, $q, $location, $translate, $modal, API, Session, Dialog) {
    $scope.properties = {
  ...
  var InfoDialogCtrl = function($scope, $modal, $modalInstance, services, item) {
    ...
    $scope.load = function(page) {
      var reqData = {
        api: 'get_receivers_auto_news_notify',
        token: token,
        id: item.id,
        skip : $scope.properties.pageSize * (page - 1),
        take : $scope.properties.pageSize
  ...
  $scope.property = {
    ...
    var reqData = {
        api: 'get_auto_news_notify_detail',
        token: token,
        id: item.id
    };
    services.API.call(reqData).then(function(res) {
  ...
  ListNewsLoginCtrl.$inject = [ '$scope', '$q', '$location', '$translate', '$modal', 'API', 'Session', 'Dialog' ];
  $app.controllers.controller('ListNewsLoginCtrl', ListNewsLoginCtrl);
