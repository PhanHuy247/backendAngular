(function () {
  var UserLogCtrl = function ($scope, $modal, Session, API, CSV, Dialog) {
  ...
  UserLogCtrl.$inject = ['$scope', '$modal', 'Session', 'API', 'CSV', 'Dialog'];
  $app.controllers.controller('UserLogCtrl', UserLogCtrl);
})();