(function() {
  var InstallationStatisticCtrl = function($scope, $filter, API, Session, Dialog) {
    ...
    $scope.type = 0; // default is date view
  ...
  InstallationStatisticCtrl.$inject = [ '$scope', '$filter', 'API', 'Session', 'Dialog' ];

  $app.controllers.controller('InstallationStatisticCtrl', InstallationStatisticCtrl);
})();